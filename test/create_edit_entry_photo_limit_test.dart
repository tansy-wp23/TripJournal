...
void main() {
  testWidgets(
    'tapping "Add photo" when already at 5 photos blocks immediately, without opening the picker sheet',
    (tester) async {
      ...
      final addPhoto = find.byKey(const Key('add-photo-button'));
      ...
      expect(
        find.text('You can add up to 5 photos per entry.'),
        findsOneWidget,
      );
