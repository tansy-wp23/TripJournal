...
void main() {
  group('durationDays', () {
    ...
    test('multi-month trip spans the boundary correctly', () {
      final trip = _trip(start: DateTime(2026, 4, 30), end: DateTime(2026, 5, 2));
  ...
  group('isActiveOn', () {
    ...
    test('true on the start date', () => expect(trip.isActiveOn(DateTime(2026, 4, 10)), isTrue));
    test('true on the end date', () => expect(trip.isActiveOn(DateTime(2026, 4, 12)), isTrue));
    test('true in the middle', () => expect(trip.isActiveOn(DateTime(2026, 4, 11)), isTrue));
    test('false the day before start', () => expect(trip.isActiveOn(DateTime(2026, 4, 9)), isFalse));
    test('false the day after end', () => expect(trip.isActiveOn(DateTime(2026, 4, 13)), isFalse));
    ...
    test('single-day trip is active only on that day', () {
      final single = _trip(start: DateTime(2026, 4, 10), end: DateTime(2026, 4, 10));
  ...
  group('dayList', () {
    ...
    test('multi-day trip lists every day inclusive, in order', () {
      final trip = _trip(start: DateTime(2026, 4, 10), end: DateTime(2026, 4, 13));
      expect(trip.dayList, [
        DateTime(2026, 4, 10),
        DateTime(2026, 4, 11),
        DateTime(2026, 4, 12),
    ...
    test('multi-month trip crosses the month boundary correctly', () {
      final trip = _trip(start: DateTime(2026, 4, 29), end: DateTime(2026, 5, 1));
      expect(trip.dayList, [
        DateTime(2026, 4, 29),
        DateTime(2026, 4, 30),
        DateTime(2026, 5, 1),
    ...
    test('length always matches durationDays', () {
      final trip = _trip(start: DateTime(2026, 1, 15), end: DateTime(2026, 3, 3));
